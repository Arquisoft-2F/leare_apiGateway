...
public class EditSectionInput {
    ...
    public EditSectionInput(String section_id, String module_id, String section_name, String section_content,
            String video_id, List<String> files_array, int pos_index) {
